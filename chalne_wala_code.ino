...
//-----------------------------------------------------------------------//   
  //----------Control Multiple Pins/ LEDs----------// 
       if(voice == "all on") {Serial.println("indide all on");allon();}  //Turn Off All Pins (Call Function)
  else if(voice == "all of"){Serial.println("indide all off");alloff();} //Turn On  All Pins (Call Function)
 
  //----------Turn On One-By-One----------//
  else if(voice == "TV on"||voice == "tv on") {digitalWrite(led1, HIGH);}
